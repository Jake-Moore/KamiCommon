...
public class OutEntityStatus_1_8_R2 implements NMSOutEntityStatus {
    ...
    public OutEntityStatus_1_8_R2(@NotNull PacketPlayOutEntityStatus packet) {
        this.packet = packet;
    }
    ...
    public int getEntityID() {
        return OutEntityStatus_1_8_R2.entityHandle.get(this.packet);
    }

    @Override
    public byte getStatus() {
        return OutEntityStatus_1_8_R2.statusHandle.get(this.packet);
    }
}
