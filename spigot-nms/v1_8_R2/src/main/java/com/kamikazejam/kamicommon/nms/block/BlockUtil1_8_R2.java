...
public class BlockUtil1_8_R2 extends AbstractBlockUtil {
    @Override
    public void setBlock(@NotNull Block b, @NotNull XBlockData blockData, @NotNull PlaceType placeType) {
        ...
        if (placeType == PlaceType.BUKKIT) {
            ...
            IBlockData ibd = net.minecraft.server.v1_8_R2.Block.getByCombinedId(legacyGetCombined(material, data));
            try {
                chunk.a(bp, ibd);
            } catch (Throwable t) {
                t.printStackTrace();
