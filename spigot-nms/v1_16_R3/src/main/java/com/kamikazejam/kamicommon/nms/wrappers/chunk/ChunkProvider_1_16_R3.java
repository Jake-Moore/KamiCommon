...
public class ChunkProvider_1_16_R3 implements NMSChunkProvider {
    ...
    public ChunkProvider_1_16_R3(@NotNull ChunkProviderServer server) {
        this.handle = server;
    }
    ...
    public @NotNull NMSChunk getOrCreateChunk(int x, int z) {
        return new Chunk_1_16_R3(Objects.requireNonNull(this.handle.getChunkAt(x, z, true)));
    }
    ...
    public @NotNull NMSChunk wrap(org.bukkit.@NotNull Chunk chunk) {
        return new Chunk_1_16_R3(((CraftChunk) chunk).getHandle());
    }
}
