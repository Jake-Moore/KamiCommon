...
public class OutEntityDestroy_1_11_R1 implements NMSOutEntityDestroy {
    ...
    public OutEntityDestroy_1_11_R1(@NotNull PacketPlayOutEntityDestroy packet) {
        this.packet = packet;
    }
    ...
    public int[] getToDestroy() {
        return (int[]) OutEntityDestroy_1_11_R1.handle.get(this.packet);
    }
}
