...
public class ChunkProvider_1_11_R1 implements NMSChunkProvider {
    ...
    public ChunkProvider_1_11_R1(@NotNull ChunkProviderServer server) {
        this.handle = server;
    }
    ...
    public @NotNull NMSChunk getOrCreateChunk(int x, int z) {
        return new Chunk_1_11_R1(this.handle.getChunkAt(x, z));
    }
    ...
    public @NotNull NMSChunk wrap(org.bukkit.@NotNull Chunk chunk) {
        return new Chunk_1_11_R1(((CraftChunk) chunk).getHandle());
    }
}
