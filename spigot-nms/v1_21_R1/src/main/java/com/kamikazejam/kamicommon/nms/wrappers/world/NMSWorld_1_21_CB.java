...
public class NMSWorld_1_21_CB implements NMSWorld {
    ...
    public NMSWorld_1_21_CB(@NotNull World world, @NotNull Provider<AbstractBlockUtil> provider) {
    ...
    public @NotNull NMSChunkProvider getChunkProvider() {
        return new ChunkProvider_1_21_CB(this, this.serverLevel.getChunkSource());
    }
