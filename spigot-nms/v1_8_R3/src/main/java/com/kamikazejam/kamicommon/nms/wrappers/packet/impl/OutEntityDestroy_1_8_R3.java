...
public class OutEntityDestroy_1_8_R3 implements NMSOutEntityDestroy {
    ...
    public OutEntityDestroy_1_8_R3(@NotNull PacketPlayOutEntityDestroy packet) {
        this.packet = packet;
    }
    ...
    public int[] getToDestroy() {
        return (int[]) OutEntityDestroy_1_8_R3.handle.get(this.packet);
    }
}
