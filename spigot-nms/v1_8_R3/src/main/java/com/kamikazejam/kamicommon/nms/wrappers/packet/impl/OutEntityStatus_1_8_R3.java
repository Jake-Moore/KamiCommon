...
public class OutEntityStatus_1_8_R3 implements NMSOutEntityStatus {
    ...
    public OutEntityStatus_1_8_R3(@NotNull PacketPlayOutEntityStatus packet) {
        this.packet = packet;
    }
    ...
    public int getEntityID() {
        return OutEntityStatus_1_8_R3.entityHandle.get(this.packet);
    }

    @Override
    public byte getStatus() {
        return OutEntityStatus_1_8_R3.statusHandle.get(this.packet);
    }
}
