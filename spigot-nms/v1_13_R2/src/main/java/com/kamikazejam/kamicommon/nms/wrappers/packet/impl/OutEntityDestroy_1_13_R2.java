...
public class OutEntityDestroy_1_13_R2 implements NMSOutEntityDestroy {
    ...
    public OutEntityDestroy_1_13_R2(@NotNull PacketPlayOutEntityDestroy packet) {
        this.packet = packet;
    }
    ...
    public int[] getToDestroy() {
        return (int[]) OutEntityDestroy_1_13_R2.handle.get(this.packet);
    }
}
