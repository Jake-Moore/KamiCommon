...
public class ItemText_1_18_R1 implements AbstractItemText {
    @Override
    public BaseComponent[] getComponents(ItemStack item) {
        ...
        return new BaseComponent[]{ new TextComponent(v1_18_R1Stack.save(new CompoundTag()).toString()) };
    }
    ...
    public String getNbtStringTooltip(ItemStack item) {
        ...
        return v1_18_R1Stack.save(new CompoundTag()).toString();
    }
}
