...
public class ItemText_1_18_R2 implements AbstractItemText {
    @Override
    public BaseComponent[] getComponents(ItemStack item) {
        ...
        return new BaseComponent[]{ new TextComponent(v1_18_R2Stack.save(new CompoundTag()).toString()) };
    }
    ...
    public String getNbtStringTooltip(ItemStack item) {
        ...
        return v1_18_R2Stack.save(new CompoundTag()).toString();
    }
}
