...
public class ChunkProvider_1_18_R2 implements NMSChunkProvider {
    private final @NotNull NMSWorld_1_18_R2 world;
    private final @NotNull ServerChunkCache handle;
    public ChunkProvider_1_18_R2(@NotNull NMSWorld_1_18_R2 world, @NotNull ServerChunkCache server) {
        this.world = world;
        this.handle = server;
    }
    ...
    public @NotNull NMSChunk getOrCreateChunk(int x, int z) {
        return new Chunk_1_18_R2(this, Objects.requireNonNull(this.handle.getChunkAtMainThread(x, z)));
    }
    ...
    public @NotNull NMSChunk wrap(org.bukkit.@NotNull Chunk chunk) {
        return new Chunk_1_18_R2(this, ((CraftChunk) chunk).getHandle());
    }
}
