...
public class Chunk_1_18_R2 implements NMSChunkDef {
    private final @NotNull ChunkProvider_1_18_R2 provider;
    private final @NotNull Chunk bukkitChunk;
    private final @NotNull LevelChunk chunk;
    public Chunk_1_18_R2(@NotNull ChunkProvider_1_18_R2 provider, @NotNull Chunk bukkitChunk) {
    ...
    public @NotNull NMSChunkSection getSection(int y) {
        return new ChunkSection_1_18_R2(this, this.chunk, y);
    }
