...
public class Chunk_1_20_R3 implements NMSChunkDef {
    private final @NotNull ChunkProvider_1_20_R3 provider;
    private final @NotNull Chunk bukkitChunk;
    private final @NotNull ChunkAccess chunk;
    public Chunk_1_20_R3(@NotNull ChunkProvider_1_20_R3 provider, @NotNull Chunk bukkitChunk) {
    ...
    public @NotNull NMSChunkSection getSection(int y) {
        return new ChunkSection_1_20_R3(this, this.chunk, y);
    }
