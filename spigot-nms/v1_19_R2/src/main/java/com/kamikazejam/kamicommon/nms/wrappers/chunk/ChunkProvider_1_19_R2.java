...
public class ChunkProvider_1_19_R2 implements NMSChunkProvider {
    ...
    public ChunkProvider_1_19_R2(@NotNull ServerChunkCache server) {
        this.handle = server;
    }
    ...
    public @NotNull NMSChunk getOrCreateChunk(int x, int z) {
        return new Chunk_1_19_R2(Objects.requireNonNull(this.handle.getChunkAtMainThread(x, z)));
    }
    ...
    public @NotNull NMSChunk wrap(org.bukkit.@NotNull Chunk chunk) {
        return new Chunk_1_19_R2(((CraftChunk) chunk).getHandle());
    }
}
