...
public class Teleporter1_15_R1 extends AbstractTeleporter {
    ...
    public void teleportWithoutEvent(Player player, Location location) {
        ...
        if (toWorld == fromWorld) {
            ...
            MinecraftServer.getServer().getPlayerList().moveToWorld(entityPlayer, toWorld.worldProvider.getDimensionManager(), true, location, true);
        }
    }
}
