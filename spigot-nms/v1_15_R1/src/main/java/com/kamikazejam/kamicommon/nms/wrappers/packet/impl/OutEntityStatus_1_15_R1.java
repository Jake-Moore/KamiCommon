...
public class OutEntityStatus_1_15_R1 implements NMSOutEntityStatus {
    ...
    public OutEntityStatus_1_15_R1(@NotNull PacketPlayOutEntityStatus packet) {
        this.packet = packet;
    }
    ...
    public int getEntityID() {
        return OutEntityStatus_1_15_R1.entityHandle.get(this.packet);
    }

    @Override
    public byte getStatus() {
        return OutEntityStatus_1_15_R1.statusHandle.get(this.packet);
    }
}
