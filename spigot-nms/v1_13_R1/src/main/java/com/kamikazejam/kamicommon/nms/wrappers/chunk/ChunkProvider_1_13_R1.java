...
public class ChunkProvider_1_13_R1 implements NMSChunkProvider {
    private final @NotNull NMSWorld_1_13_R1 world;
    private final @NotNull ChunkProviderServer handle;
    public ChunkProvider_1_13_R1(@NotNull NMSWorld_1_13_R1 world, @NotNull ChunkProviderServer server) {
        this.world = world;
        this.handle = server;
    }
    ...
    public @NotNull NMSChunk getOrCreateChunk(int x, int z) {
        return new Chunk_1_13_R1(this, this.handle.getChunkAt(x, z));
    }
    ...
    public @NotNull NMSChunk wrap(org.bukkit.@NotNull Chunk chunk) {
        return new Chunk_1_13_R1(this, ((CraftChunk) chunk).getHandle());
    }
}
