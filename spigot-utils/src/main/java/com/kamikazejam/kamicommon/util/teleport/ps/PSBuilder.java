...
public class PSBuilder {
    ...
    public PSBuilder world(String worldName) {
    ...
    public PSBuilder blockX(Integer blockX) {
        this.blockX = blockX;
        return this;
    }
    ...
    public PSBuilder blockY(Integer blockY) {
        this.blockY = blockY;
        return this;
    }
    ...
    public PSBuilder blockZ(Integer blockZ) {
        this.blockZ = blockZ;
        return this;
    }
    ...
    public PSBuilder locationX(Double locationX) {
    ...
    public PSBuilder locationY(Double locationY) {
    ...
    public PSBuilder locationZ(Double locationZ) {
    ...
    public PSBuilder chunkX(Integer chunkX) {
        this.chunkX = chunkX;
        return this;
    }
    ...
    public PSBuilder chunkZ(Integer chunkZ) {
        this.chunkZ = chunkZ;
        return this;
    }
    ...
    public PSBuilder pitch(Float pitch) {
        this.pitch = pitch;
        return this;
    }
    ...
    public PSBuilder yaw(Float yaw) {
        this.yaw = yaw;
        return this;
    }
    ...
    public PSBuilder velocityX(Double velocityX) {
    ...
    public PSBuilder velocityY(Double velocityY) {
    ...
    public PSBuilder velocityZ(Double velocityZ) {
