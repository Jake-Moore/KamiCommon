 ...
 * The {@link #modify} method also provides the existing item in the menu, if it exists.
 */
public non-sealed interface StatefulIconModifier extends MenuIconModifier {
     ...
     */
    void modify(@NotNull IBuilder initialBuilder, @Nullable ItemStack currentItem);
}
