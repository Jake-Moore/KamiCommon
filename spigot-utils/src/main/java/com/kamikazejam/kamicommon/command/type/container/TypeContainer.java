...
import com.kamikazejam.kamicommon.command.editor.CommandEditContainer;
...
public abstract class TypeContainer<C, E> extends TypeAbstract<C> {
	...
	public <X> X setIndexStart(int indexStart) {
	...
	@SuppressWarnings("unchecked")
	public <X> X setIndexVisible(boolean indexVisible) {
	...
	@Override
	public C read(String arg, CommandSender sender) throws KamiCommonException {
		// Create
