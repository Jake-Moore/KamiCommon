...
public class ItemText_1_19_R1 implements ItemText {
    @Override
    public BaseComponent[] getComponents(ItemStack item) {
        ...
        return new BaseComponent[]{ new TextComponent(v1_19_R1Stack.b(new NBTTagCompound()).toString()) };
    }
    ...
    public String getNbtStringTooltip(ItemStack item) {
        ...
        return v1_19_R1Stack.b(new NBTTagCompound()).toString();
    }
}
